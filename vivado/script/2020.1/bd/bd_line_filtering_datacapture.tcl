...
# module references:
# butterbp, cen_generator_v1_0, datacapture
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net butterbp_0_Out [get_bd_pins butterbp_0/Out] [get_bd_pins datacapture_0/filter_output]
  connect_bd_net -net butterbp_0_ce_out [get_bd_pins butterbp_0/ce_out] [get_bd_pins datacapture_0/clk_enable]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins AXI_Stream_ZMOD_ADC_0/adc_clk] [get_bd_pins AXI_Stream_ZMOD_ADC_0/clk_spi] [get_bd_pins AXI_Stream_ZMOD_ADC_0/m00_axis_aclk] [get_bd_pins butterbp_0/clk] [get_bd_pins cen_generator_v1_0_0/clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins datacapture_0/clk]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins butterbp_0/In] [get_bd_pins datacapture_0/filter_input] [get_bd_pins xlslice_0/Dout]
